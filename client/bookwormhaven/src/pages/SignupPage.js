...
const Signup = () => {
  ...
  const validatePassword = (password) => {
    // Basic validation: at least 8 characters, one lower, one upper, and one number
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validatePassword(password)) {
      setPasswordError('Password must be at least 8 characters long and include lowercase, uppercase, and a number.');
      return;
    }
    try {
