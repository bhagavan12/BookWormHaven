...
//   // Define menu items with scroll commands
//   const items = [
//     {
//       label: 'Features',
//       icon: 'pi pi-sparkles',
//       command: () => featuresRef.current.scrollIntoView({ behavior: 'smooth' }) // Scroll to Features
//     },
//     {
//       label: 'Testimonials',
//       icon: 'pi pi-pencil',
//       command: () => testimonialsRef.current.scrollIntoView({ behavior: 'smooth' }) // Scroll to Testimonials
//     },
//     {
//       label: 'Trending Books',
//       command: () => trendingBooksRef.current.scrollIntoView({ behavior: 'smooth' }) // Scroll to Trending Books
//     }
//   ];
...
//           <h1 className=''>Welcome to Bookrary</h1>
...
//             <Link to='/login' className='p-button'>Sign in</Link>
//             <Link to='/signup' className='p-button'><i className='pi pi-user-plus'></i>Sign Up</Link>
//           </Button>
//         </div>
...
import Signup from './SignupPage'; // Import the Signup component
import CoverImg from '../assets/bookcover.png';
import logo from '../assets/logo.png';
import '../Styling/Landingpage.css';
  ...
  return (
    <div className='fullc'>
        ...
        <div className='content' style={{ background: "rgba(255, 255, 255, 0.26)", boxShadow: " 0px 4px 30px rgba(0, 0, 0, 0.1)", backdropFilter: "blur(5px)" }}>
          ...
          <Button style={{ display: "flex", flexDirection: 'row', margin: "auto", gap: "5px" }} outlined>
            <Button
              ...
              onClick={() => setLoginVisible(true)} // Open login modal
              outlined
            >
              Sign in
            </Button>
            <Button
              style={{ display: "flex", flexDirection: 'row', margin: "auto", gap: "5px" }}
              onClick={() => setSignupVisible(true)} // Open signup modal
              outlined
            >
      ...
      <Dialog
        ...
        style={{ width: '30vw' }}
        onHide={() => setLoginVisible(false)} // Close the modal
      >
        <Login />
      </Dialog>
